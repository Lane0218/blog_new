...
export default defineUserConfig({
  ...
  theme: plumeTheme({
    ...
    hostname: 'https://www.lane0218.top/',

    /* 文档仓库配置，用于 editLink */
    docsRepo: 'https://github.com/Lane0218/blog_new',
    docsDir: 'docs',
    docsBranch: 'master',
    ...
    plugins: {
      ...
      docsearch: {
        appId: 'ZSTT5BBSV9',
        apiKey: 'ac33b00bfc5a88b572fb7fd3ccad0fcc',
        indexName: 'lane0218',
      },
      ...
      comment: {
        ...
        comment: true,
        repo: 'Lane0218/blog_new',
        repoId: 'R_kgDONqtSng',
        category: 'Announcements',
        categoryId: 'DIC_kwDONqtSns4CmFEL',
      },
    },
